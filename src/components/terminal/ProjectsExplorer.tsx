  ...
  const fileTree: FileItem[] = [
    {
      ...
      children: [
        ...
        { name: "components", type: "folder", icon: "folder", color: "text-ansi-yellow" },
        {
          ...
          expanded: true,
          children: [
            { name: "summarist.tsx", type: "file", icon: "auto_stories", color: "text-ansi-blue", projectId: "PRJ-SUMMARIST-001" },
            { name: "portfolio.tsx", type: "file", icon: "terminal", color: "text-ansi-green", projectId: "PRJ-PORTFOLIO-001" },
            { name: "ai_chatbot.py", type: "file", icon: "smart_toy", color: "text-ansi-cyan", projectId: "PRJ-AICHATBOT-001" },
            { name: "nexgen_cloud.ts", type: "file", icon: "cloud", color: "text-ansi-magenta", projectId: "PRJ-NEXGEN-001" },
            { name: "daansetu.tsx", type: "file", icon: "volunteer_activism", color: "text-ansi-yellow", projectId: "PRJ-DAANSETU-001" },
            { name: "kirana_corner.tsx", type: "file", icon: "store", color: "text-ansi-green", projectId: "PRJ-KIRANA-001" },
            { name: "arduino_safety.ino", type: "file", icon: "developer_board", color: "text-ansi-cyan", projectId: "PRJ-EMBEDDED-001" },
            { name: "fangate.tsx", type: "file", icon: "music_note", color: "text-ansi-magenta", projectId: "PRJ-FANGATE-001" },
          ],
        },
      ],
    },
